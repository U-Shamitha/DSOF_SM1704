...
import PostWidget from 'socialMedia/scenes/widgets/PostWidget';
import { setUserPost, setPostedUser } from 'socialMedia/state';
...
const getUserPost = async () => {
  ...
  setPost(data[0]);
  dispatch({type:'SETUSERPOSTS_SM', payload: {userposts_sm: data[0]}})
  console.log(post)
    ...
    <Box>
      ...
      >
        <Box flexBasis={isNonMobileScreens ? "26%" : undefined }>
          <UserWidget userId={post.userId} profileUrl={post.userProfileUrl} />
          <Box m='2rem 0' />
