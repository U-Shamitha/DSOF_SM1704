      ...
      { showMatchedUsers && 
        ...
        <Select value={user.firstName} >
          {userSearchList.map((userp)=> (
            <MenuItem key={userp._id} value={userp._id} onClick={(e) => {navigate(`/Community/sm/profile/${userp._id}`);navigate(0)}} >
        ...
        <FormControl variant="standard" value={fullName}>
          <Select
            ...
            >
              ...
              <MenuItem onClick={()=> {navigate('/Community/sm');dispatch({type:'SETLOGOUT_SM'})}}>Log Out</MenuItem>
